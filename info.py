...
PICS = (environ.get('PICS', 'https://te.legra.ph/file/b9ef16aa49e669fb14da7.jpg')).split()
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001962836589')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001910513374')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ac_films05')
